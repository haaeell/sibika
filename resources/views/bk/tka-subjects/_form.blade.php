...
<div class="grid gap-4 md:grid-cols-2">
    <x-form.input name="code" label="Kode Mapel TKA" icon="fa-solid fa-hashtag" placeholder="Contoh: TKA-MAT" :value="old('code', $tkaSubject->code)" />
    <x-form.input name="name" label="Nama Mapel TKA" icon="fa-solid fa-book" placeholder="Contoh: Matematika TKA" :value="old('name', $tkaSubject->name)" />
</div>
